...
export default function LinkPreviewCard({ url }: { url: string }) {
  ...
  return (
    <a 
      ...
      className="flex gap-4 p-0 bg-white hover:bg-gray-50 rounded-2xl border border-gray-100 transition-all group overflow-hidden my-6"
    >
      {data.image && (
        <div className="w-24 md:w-40 shrink-0 border-r border-gray-50 overflow-hidden bg-gray-50">
          <img 
            src={data.image} 
            alt={data.title} 
